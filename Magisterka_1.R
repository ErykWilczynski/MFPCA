...
plotfd(fdX)
plotfd(fdX, main = 'Liczba ludnoœci w wieku przedprodukcyjnym', ylab = '')
plotfd(fdY, main = 'Liczba ludnoœci w wieku mobilnym', ylab = '')
plotfd(fdA, main = 'Liczba ludnoœci w wieku niemobilnym', ylab = '')
plotfd(fda, main = 'Liczba ludnoœci w wieku poprodukcyjnym', ylab = '')
plotfd(fdb, main = 'Liczba ludnoœci w wieku nieprodukcyjnym na 100 w wieku produkcyjnym', ylab='')
View(sdata)
